...
L_result = subs(L_expect(z),z,wall1);
L_result1 = subs(L_expect(z),z,wall15);
L_result2 = subs(L_expect(z),z,wall2);
L_result3 = subs(L_expect(z),z,wall3);

EE_result = subs(L_expect(z),z,z_spare)-0.1;
EE_result1 = subs(L_expect(z),z,z_spare1)-0.05;
EE_result2 = subs(L_expect(z),z,z_spare2);
EE_result3 = subs(L_expect(z),z,z_spare3)+0.2;
