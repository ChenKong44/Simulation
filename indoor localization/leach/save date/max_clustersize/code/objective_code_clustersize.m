...
% basedistance =  sqrt(81./4./(density1))+sqrt(78./4./(density1)) ;
% 
...
% h_result = subs(h_constraint,{a,b},{z_spare2_100,z_spare_100});
% h_result1 = subs(h_constraint,{a,b},{round(z_spare2_50),z_spare_50});
% h_result2 = subs(h_constraint,{a,b},{round(z_spare2_25),z_spare_25});
