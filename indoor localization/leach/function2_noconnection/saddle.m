...
%     iteration=2;
    for t = 1:1:iteration
        ...
        [z, lamda, target, theta,L_result,H_result] = some_function2(2, target, t, z, lamda, theta,L_result,H_result,underground_prob,aboveground_prob);
        [z, lamda, target, theta,L_result,H_result] = some_function3(3, target, t, z, lamda, theta,L_result,H_result,underground_prob,aboveground_prob);
        [z, lamda, target, theta,L_result,H_result] = some_function4(4, target, t, z, lamda, theta,L_result,H_result,underground_prob,aboveground_prob);
