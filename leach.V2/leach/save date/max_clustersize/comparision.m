...
hold on;
plot(x, z_spare2_50, 'r-', 'LineWidth', 2); % Plot fitted line.

hold on;
plot(x, z_spare2_100, 'k-', 'LineWidth', 2); % Plot fitted line.
...
legend('Max clustersize: 25','Max clustersize: 50','Max clustersize: 100')
