function [z, lamda, target, theta,L_result,iteration_delay,z_spare3] = some_function3(index, target, iteration, z, lamda, theta,L_result,iteration_delay,z_spare3)
    step_size = 0.065;
    delta = 1e-1;
...
%     fprintf('laplase: %.5f\n',laplase);
    ...
    z_spare3=[z_spare3,round(z(index))];
