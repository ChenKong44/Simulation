function [z, lamda, target, theta,L_result,H_result,iteration_delay,z_spare3] = some_function3(index, target, iteration, z, lamda, theta,L_result,H_result,iteration_delay,z_spare3)
    step_size = 0.08;
    delta = 1e-1;
