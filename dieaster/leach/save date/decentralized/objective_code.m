...
L_result2 = subs(L_expect(z),z,z_spare22);

syms a b
h_constraint(a,b) = 3./2.*(sqrt(a./4./(density1))+sqrt(b./4./(density1)))-4.5;
h_result = subs(h_constraint,{a,b},{z_spare,z_spare2});
h_result1 = subs(h_constraint,{a,b},{z_spare2_50,z_spare2_50});
h_result2 = subs(h_constraint,{a,b},{z_spare22,z_spare11});
...
for h = 1:1:10   % Loop over h from 1 to 100 with a step size of 1
    for t = 1:100:1000   % Loop over t from 1 to 1000 with a step size of 10
        ...
        z_spare_difference(index) = 40 - z_spare2(t);
        z_spare_difference1(index) = 40 - z_spare2_50(t);
        z_spare_difference2(index) = 40 - z_spare22(t);
    end
end
...
hold on;
plot(x, z_spare22, 'k:', 'LineWidth', 2); % Plot fitted line.
...
hold on;
plot(z, h_result1, 'k-', 'LineWidth', 2); % Plot fitted line.
