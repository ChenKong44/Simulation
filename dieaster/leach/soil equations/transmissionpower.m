function [bitrate,Energy_transit_b,Energy_transit_cm,Energy_transit_cm_cm] = transmissionpower(basedistance, aboveground,mean_CMS_distance,moisture,frequency,temperature)
