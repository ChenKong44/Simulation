...
%       aggrEnergy  Data aggregation energy     
    ...
    %%%% Create cluster head
    Clusterhead1.x = Yard.Length / 2.5;
    Clusterhead1.y = Yard.Width / 4;

    Clusterhead2.x = Yard.Length / 1.6;
    Clusterhead2.y = Yard.Width / 1.5;
    ...
    NetArch = struct('Yard',   Yard, ...
                     'Sink',   Sink, ...
                     'Clusterhead1',   Clusterhead1, ...
                     'Clusterhead2',   Clusterhead2, ...
                     'Energy', Energy);
end